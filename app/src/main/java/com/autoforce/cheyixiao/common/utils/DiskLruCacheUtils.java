    ...
    public static DiskLruCache getDiskLruCache(Context context) {
        ...
        try {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                diskLruCache = DiskLruCache.open(new File(cachePath), Integer.parseInt(AppMessageUtils.getAppVersionCode(context)), 1, 1024 * 1024 * 1024);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String getSavedFileContentStr(DiskLruCache diskLruCache, String fileKey) {
        ...
        try {
            ...
            try {
                ...
                if (savedFileInputStream != null) {savedFileInputStream.close();}
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
